#ifndef CUSTOMTEXTRECTANGLE_H
#define CUSTOMTEXTRECTANGLE_H
#include <QInputDialog>
#include "customrectangle.h"
/**
 * @brief The CustomTextRectangle class
 * @details This class is a reimplementation of CustomRectangle
 * it contains all data a rectangle with text needed
 * @author Lars Telöken
 * @version 1.0
 * @date 2019-01-27
 */
class CustomTextRectangle : public CustomRectangle
{
private:
    /**
     * @brief m_textItem - the text item member
     * @details contains the text item of the textRectangle
     */
    QGraphicsTextItem *m_textItem;
    /**
     * @brief m_lineItem - the line item member
     * @details contains the line item of the textRectangle
     */
    QGraphicsLineItem *m_lineItem;
    /**
      * @brief m_text - the text member
      * @details contains the text of the textRectangle
      */
    QString m_text;
public:
    /**
     ...
     */
    CustomTextRectangle(qreal x, qreal y, qreal width, qreal height, qreal borderSize, QBrush brush, app::AppState *appState, QString text);
    /**
    ...
    int type() const;
    /**
     * @brief ~CustomTextRectangle - the destructor of the class
     */
    ~CustomTextRectangle();
protected:
     ...
     * it handle the action if a textRectangle is clicked
     */
    void mousePressEvent(QGraphicsSceneMouseEvent *event);
    /**
     * @brief mouseReleaseEvent - a override function
     * @param event - the current event of the mouse
     * @details is danle the action if a textRectangle mouse click is released
     */
    void mouseReleaseEvent(QGraphicsSceneMouseEvent *event);
};

#endif // CUSTOMTEXTRECTANGLE_H
